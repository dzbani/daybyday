...
const replacements = JSON.parse(fs.readFileSync(path.join(__dirname, 'suspicious_replacements.json'), 'utf8'));
...
if (missing.length) console.log('BRAKUJĄCE DOPASOWANIA:', JSON.stringify(missing, null, 1));
