...
const replacements = JSON.parse(fs.readFileSync(path.join(__dirname, 'unverifiable_batch6_result.json'), 'utf8'));

let applied = 0, removed = 0, missing = [];
...
console.log('Zastosowano:', applied, '| Usunięto (brak zamiennika):', removed, '| Razem:', applied + removed, '/', replacements.length);
